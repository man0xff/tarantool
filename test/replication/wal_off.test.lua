...
while box.info.replication[wal_off_id].downstream.message ~= check do fiber.sleep(0) end
box.info.replication[wal_off_id].downstream ~= nil
box.info.replication[wal_off_id].upstream ~= nil
box.info.replication[wal_off_id].downstream.status
box.info.replication[wal_off_id].downstream.message
box.cfg { replication = "" }
